...
fun createSetBlocksTool(worldEdit: WorldEditService): ToolDefinition = ToolDefinition(
    name = "set_blocks",
    ...
    toolResult {
        ...
        worldEdit.setBlocks(region.pos("pos1"), region.pos("pos2"), material)
            .toToolResult { blocks -> "Set $blocks blocks to $material" }
    }
}
